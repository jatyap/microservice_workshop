...
public class AlternativeProvider1 implements River.PacketListener {

	private RapidsConnection rapidsConnection = null;
	private River river = null;

	public AlternativeProvider1(RapidsConnection connection) {
	...
	public static void main(String[] args) {
		...
		final RapidsConnection rapidsConnection = new RabbitMqRapids("alternativeProvider", host, port);
		...
		// queried and set in a packet
															// river to start
		// receiving traffic
		river.register(new AlternativeProvider1(rapidsConnection)); // Hook up to the
	}
...
//		packet.put("solutions", solutions.toArray());
		...
		packet.put("solutions", Offer.limitedOffer(4500));
